...
import random
# engine
from stable_diffusion_onnx import StableDiffusionEngine
# scheduler
...
def main(args):
    ...
    print("begin create StableDiffusionEngine")
    ...
    print(f"wrige image to {args.output}")
...
if __name__ == "__main__":
    ...
    # inference device
    parser.add_argument("--device", type=str, default="GPU", help=f"inference device, CPU or GPU")
    # randomizer params
    ...
    parser.add_argument("--prompt", type=str,
                        default="Street-art painting of Emilia Clarke in style of Banksy, photorealism", help="prompt")
    # Parameter re-use:
